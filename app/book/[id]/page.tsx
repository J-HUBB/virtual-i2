              ...
              <>
                <div className="inner__book">
                  <div className="inner-book__title">
                    <Skeleton width="281px" height="38px" display="block" />
                  </div>
                  <div className="inner-book__author">
                    <Skeleton width="200px" height="19px" display="block" />
                  </div>
                  <div className="inner-book__sub--title">
                    <Skeleton width="350px" height="24px" display="block" />
                  </div>
                  {/* <div className="inner-book__wrapper">
                    <Skeleton width={"281px"} height={"93"} display={"block"} />
                  </div> */}
                  <div className="inner-book__read--btn-wrapper">
                    <Skeleton width="262px" height="48px" display="block" />
                  </div>
                  <div
                    className="inner-book__bookmark"
                    style={{ width: "300px", height: "22px", display: "block" }}
                  >
                    <Skeleton width={"400"} height={"22px"} display={"block"} />
                  </div>
                  <div className="inner-book__secondary--title">
                    <Skeleton width="200px" height="22px" display="block" />
                  </div>
                  <div className="inner-book__tags--wrapper">
                    <Skeleton width="362px" height="48px" display="block" />
                  </div>
                  <div className="inner-book__book--description">
                    <Skeleton width="562px" height="264px" display="block" />
                  </div>
                  <h2 className="inner-book__secondary--title">
                    <Skeleton width="252px" height="22px" display="block" />
                  </h2>
                ...
                <div className="inner-book--img-wrapper">
                  ...
                  >
                    <Skeleton width="300px" height="300px" display="block" />
                  </figure>
                </div>
              </>
            ) : (
