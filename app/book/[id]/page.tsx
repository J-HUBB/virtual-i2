...
const BooksPage = ({subscriptionRequired}: book) => {
          ...
          <div className="inner__wrapper">
            <div className="inner__book">
              ...
              <div className="inner-book__read--btn-wrapper">
                ...
                <button className="inner-book__read--btn" onClick={() => `/player/${id}`}>
                ...
                </button>) : (<button className="inner-book__read--btn" onClick={() => dispatch(openModal())}>
                  <div className="inner-book__read--icon">
                    <svg
                      stroke="currentColor"
                      fill="currentColor"
